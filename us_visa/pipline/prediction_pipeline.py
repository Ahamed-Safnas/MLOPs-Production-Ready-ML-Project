...
#predict from the model in the s3 bucket(AWS)
class USvisaData:
    def __init__(self,
                continent,
                ...
                full_time_position,
                company_age
                ): #these are the input we get from the user for prediction
        """
    ...
    def get_usvisa_data_as_dict(self):
        ...
        try: # we convert input data to dictionary format, so ican easily convert to dataframe
            input_data = {
